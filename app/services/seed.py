...
DEMO_USERS = [
    ("Devon Carter", "devon.carter@example.com", "Administrator"),
    ("Priya Shah", "priya.shah@example.com", "Case Manager"),
    ("Marcus Chen", "marcus.chen@example.com", "Procurement Analyst"),
    ("Elena Ruiz", "elena.ruiz@example.com", "Risk Reviewer"),
    ("Amina Brooks", "amina.brooks@example.com", "Finance Approver"),
    ("Jordan Lee", "jordan.lee@example.com", "Access Coordinator"),
    ("Taylor Morgan", "taylor.morgan@example.com", "Manager"),
    ("Noah Williams", "noah.williams@example.com", "Security Reviewer"),
    ("Sofia Patel", "sofia.patel@example.com", "IT Provisioner"),
    ("Maya Thompson", "maya.thompson@example.com", "Customer Care Analyst"),
    ("Owen Kim", "owen.kim@example.com", "Complaint Investigator"),
    ("Grace Johnson", "grace.johnson@example.com", "Customer Care Manager"),
]
...
def seed_database(db: Session, root: Path) -> None:
    ...
    northstar = create_case(
        ...
        requester_email="morgan.ellis@example.com",
        priority="Medium",
        field_values={
    ...
    summit = create_case(
        ...
        requester_email="avery.robinson@example.com",
        priority="High",
        field_values={
    ...
    blue_peak = create_case(
        ...
        requester_email="riley.carter@example.com",
        priority="High",
        field_values={
    ...
    payroll = create_case(
        ...
        requester_email="jamie.davis@example.com",
        priority="Medium",
        field_values={
            "employee_name": "Jamie Davis",
            "employee_email": "jamie.davis@example.com",
    ...
    finance_dw = create_case(
        ...
        requester_email="alex.garcia@example.com",
        priority="Critical",
        field_values={
            "employee_name": "Alex Garcia",
            "employee_email": "alex.garcia@example.com",
    ...
    billing = create_case(
        ...
        requester_email="sam.wilson@example.com",
        priority="High",
        field_values={
    ...
    outage = create_case(
        ...
        requester_email="drew.allen@example.com",
        priority="Medium",
        field_values={
            "customer_name": "Drew Allen",
            "contact_email": "drew.allen@example.com",
            "channel": "Phone",
    ...
    privacy = create_case(
        ...
        requester_email="robin.harris@example.com",
        priority="Critical",
        field_values={
            "customer_name": "Robin Harris",
            "contact_email": "robin.harris@example.com",
            "channel": "Regulator",
            "category": "Privacy",
